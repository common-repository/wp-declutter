...
$wp_head = array(
	...
	'rest_output_link_wp_head' => array(
		'desc' => 'Link to the WordPress REST API endpoint.',
		'example' => '<link rel="https://api.w.org/" href="http://example.com/wp-json/" />'),
	'wp_oembed_add_discovery_links' => array(
		'desc' => 'JSON and oEmbed links for posts.',
		'example' => '<link rel="alternate" type="application/json+oembed" href="http://localhost/wp/wp-json/oembed/1.0/embed?url=http%3A%2F%example.com%2Fhello-world%2F" />'),
	'print_emoji_detection_script' => array(
		'desc' => 'Emoji detection Javascript inserted by WordPress to check browser support for Emojis.'),
	'print_emoji_styles' => array(
		'desc' => 'Emoji CSS inserted by WordPress for styling Emojis.'),
);
